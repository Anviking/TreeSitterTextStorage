...
extension String {
    public func tokenize(as language: Language, theme: ColorTheme, font: UIFont) -> NSMutableAttributedString {
        ...
        let attributedString = NSMutableAttributedString(string: self, attributes: [NSAttributedStringKey.font: font, NSAttributedStringKey.foregroundColor: UIColor.black])
